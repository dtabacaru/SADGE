...
#ifdef ENABLED
TEST(Instructions, OP0x00) { TestOpcode(0x00); } 
TEST(Instructions, OP0x01) { TestOpcode(0x01); } 
...
TEST(Instructions, OP0x11) { TestOpcode(0x11); } 
...
TEST(Instructions, OP0x21) { TestOpcode(0x21); } 
